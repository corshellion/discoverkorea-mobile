...
class ProfileApp2 extends StatefulWidget {
  @override
  _ProfilesScreenState createState() => _ProfilesScreenState();
}

class _ProfilesScreenState extends State<ProfileApp2> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        bio ?? "Tidak ada biodata pada profil ini...",
                        style: TextStyle(
                          fontSize: 16.0,
