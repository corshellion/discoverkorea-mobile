...
void main() => runApp(new Uploadfile());
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future uploadImage() async {
   ...
   try{
     ...
     var res1 = await sendForm('https://discoverkorea.site/apiuser/unggahapiunggahanpengguna',
         {'name': username, 'title': _title.text, 'status': _status.text}, {'file': imageFile});
     print("res-1 $res1");
     setState(() {
       imageFile = image;
     });
