...
void main() => runApp(new UploadfileFanbase());

class UploadfileFanbase extends StatelessWidget {
...
class _MyHomePageState extends State<MyHomePage> {
        ...
        onTap: (){
          ...
          child: new Container(
            ...
            child: imageFile == null
                ? new Image.asset('assets/discoverkorea-sejarah.png', colorBlendMode: BlendMode.darken, color: Colors.white, fit: BoxFit.cover)
  ...
  Future uploadImage() async {
   ...
   try{
     ...
     var res1 = await sendForm('https://discoverkorea.site/apiuser/unggahapiunggahanfanbase',
         {'name': username, 'title': _title.text,'idfanbase':idfangrup, 'status': _status.text}, {'file': imageFile});
     print("res-1 $res1");
     setState(() {
       imageFile = image;
     });
     ...
     _showSnackbar('Gagal unggah, pastikan gambar, judul dan deskripsi terisi: $e');
   }
  }
