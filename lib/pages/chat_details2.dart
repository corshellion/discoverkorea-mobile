...
class ChatDetails2 extends StatefulWidget {
  ...
  ChatDetails2({this.username, this.receiver, this.uidreceiverpas});

  @override
  _ChatDetailsState createState() => _ChatDetailsState();
}

class _ChatDetailsState extends State<ChatDetails2> {
                ...
                child: Container(
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => OtherProfileApp(username: usernamereceiver)),
                      );
                    },
                    child: Icon(
                      Icons.arrow_back,
